...
@Entity
@Table(name = "service_schedule", schema = "queuerite", catalog = "")
public class ServiceSchedule {
    ...
    public boolean equals(Object o) {
        ...
        if (dayOfWeekType != null ? !dayOfWeekType.equals(that.dayOfWeekType) : that.dayOfWeekType != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (dayOfWeekType != null ? dayOfWeekType.hashCode() : 0);
